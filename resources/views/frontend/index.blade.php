        ...
        <div class="row align-items-center justify-content-center justify-content-lg-between">
            ...
            <div class="col-xl-5 col-lg-6">
                <div class="banner__content">
                    <h2 class="title wow fadeInUp" data-wow-delay=".2s"><span>I will deliver to you, the Best</span> <br> Product in the shortest time.</h2>
                    <p class="wow fadeInUp" data-wow-delay=".4s">I'm a Laravel based web developer and software engineer focused on crafting clean, aesthetic, functional & user‑friendly experiences</p>
            ...
            <div class="col-lg-6">
                <div class="about__content">
                    <div class="section__title">
                        ...
                        <h2 class="title">I will transform your ideas into remarkable digital products</h2>
                    </div>
